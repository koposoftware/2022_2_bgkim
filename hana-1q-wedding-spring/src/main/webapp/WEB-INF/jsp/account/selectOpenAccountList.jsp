          ...
          function callother(result) {
             ...
             for(let i = 0; i < result.length; i++){
                ...
                if(bankCode =='2'){
                	...
                	$('#MyAccount').append('<div class="pricing-card" style="margin:40px"><div class="card border-light text-center" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"><div class="card-body" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"><div class="col-12 d-flex align-items-center justify-content-center"><div class="d-flex justify-content-center"><div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 fmxw-400 item"><div class="ms-0 me-0 text-center text-md-center mb-5 mt-md-0 w-100"><img src="img_2/hanalogo.png" class="img-fluid image-sm" style="width:150px;height:150px"></div><form action="/accountTransferForm" method="post"><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-image-portrait" >&nbsp;<strong>이름 :</strong> &emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="name" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+' ${member.name}'+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-list-ol" >&nbsp;<strong>계좌번호 :</strong>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="accountNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+accountNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-phone">&nbsp;<strong>핸드폰번호 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="phoneNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+phoneNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-regular fa-calendar" >&nbsp;<strong>계좌개설일 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankRegDate+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-won-sign" >&nbsp;<strong>잔액 :</strong>&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+balance+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-coins" >&nbsp;<strong>이체한도 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="transferLimit" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+transferLimit+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-brands fa-lastfm" >&nbsp;<strong>계좌명칭 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankAlias" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankAlias+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-code" >&nbsp;<strong>은행코드</strong>:&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankCode" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankCode+' readonly></div></div><button id="joinbtn" type="submit" class="btn btn-block btn-primary w-100">축의금 송금하기</button></form></div></div></div></div></div>');
                	
                } else if(bankCode =='9'){
                	
                	$('#MyAccount').append('<div class="pricing-card" style="margin:40px"><div class="card border-light text-center" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="card-body" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="col-12 d-flex align-items-center justify-content-center"><div class="d-flex justify-content-center"><div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 fmxw-400 item"><div class="ms-0 me-0 text-center text-md-center mb-5 mt-md-0 w-100"><img src="img_2/kblogo.png" class="img-fluid image-sm" style="width:150px;height:150px"></div><form action="/accountTransferForm" method="post"><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-image-portrait" >&nbsp;<strong>이름 :</strong> &emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="name" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+' ${member.name}'+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-list-ol" >&nbsp;<strong>계좌번호 :</strong>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="accountNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+accountNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-phone">&nbsp;<strong>핸드폰번호 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="phoneNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+phoneNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-regular fa-calendar" >&nbsp;<strong>계좌개설일 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankRegDate+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-won-sign" >&nbsp;<strong>잔액 :</strong>&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+balance+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-coins" >&nbsp;<strong>이체한도 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="transferLimit" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+transferLimit+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-brands fa-lastfm" >&nbsp;<strong>계좌명칭 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankAlias" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankAlias+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-code" >&nbsp;<strong>은행코드</strong>:&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankCode" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankCode+' readonly></div></div><button id="joinbtn" type="submit" class="btn btn-block btn-primary w-100">축의금 송금하기</button></form></div></div></div></div></div>');
                	
                } else if(bankCode =='14'){
                	
                	$('#MyAccount').append('<div class="pricing-card" style="margin:40px"><div class="card border-light text-center" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="card-body" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="col-12 d-flex align-items-center justify-content-center"><div class="d-flex justify-content-center"><div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 fmxw-400 item"><div class="ms-0 me-0 text-center text-md-center mb-5 mt-md-0 w-100"><img src="img_2/shinlogo.png" class="img-fluid image-sm" style="width:150px;height:150px"></div><form action="/accountTransferForm" method="post"><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-image-portrait" >&nbsp;<strong>이름 :</strong> &emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="name" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+' ${member.name}'+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-list-ol" >&nbsp;<strong>계좌번호 :</strong>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="accountNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+accountNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-phone">&nbsp;<strong>핸드폰번호 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="phoneNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+phoneNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-regular fa-calendar" >&nbsp;<strong>계좌개설일 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankRegDate+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-won-sign" >&nbsp;<strong>잔액 :</strong>&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+balance+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-coins" >&nbsp;<strong>이체한도 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="transferLimit" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+transferLimit+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-brands fa-lastfm" >&nbsp;<strong>계좌명칭 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankAlias" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankAlias+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-code" >&nbsp;<strong>은행코드</strong>:&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankCode" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankCode+' readonly></div></div><button id="joinbtn" type="submit" class="btn btn-block btn-primary w-100">축의금 송금하기</button></form></div></div></div></div></div>');
                	
                } else{
                	
                	$('#MyAccount').append('<div class="pricing-card" style="margin:40px"><div class="card border-light text-center" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="card-body" style="width: 500px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 50px;"><div class="col-12 d-flex align-items-center justify-content-center"><div class="d-flex justify-content-center"><div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 fmxw-400 item"><div class="ms-0 me-0 text-center text-md-center mb-5 mt-md-0 w-100"><img src="img_2/woorilogo.png" class="img-fluid image-sm" style="width:150px;height:150px"></div><form action="/accountTransferForm" method="post"><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-image-portrait" >&nbsp;<strong>이름 :</strong> &emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="name" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+' ${member.name}'+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-list-ol" >&nbsp;<strong>계좌번호 :</strong>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="accountNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+accountNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-phone">&nbsp;<strong>핸드폰번호 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="phoneNumber" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+phoneNumber+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-regular fa-calendar" >&nbsp;<strong>계좌개설일 :</strong>&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankRegDate+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-won-sign" >&nbsp;<strong>잔액 :</strong>&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankRegDate" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+balance+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-coins" >&nbsp;<strong>이체한도 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="transferLimit" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+transferLimit+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-brands fa-lastfm" >&nbsp;<strong>계좌명칭 :</strong>&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankAlias" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankAlias+' readonly></div></div><div class="form-group"><div class="input-group mb-4 w-100"><div class="input-group-prepend"><span class="input-group-text"><span class="fa-solid fa-code" >&nbsp;<strong>은행코드</strong>:&nbsp;&nbsp;&nbsp;</span></span></div><input class="form-control" name="bankCode" id="exampleInputIcon4" placeholder="ID" type="text" aria-label="email adress" value='+bankCode+' readonly></div></div><button id="joinbtn" type="submit" class="btn btn-block btn-primary w-100">축의금 송금하기</button></form></div></div></div></div></div>');
